...
class BadRequestResponseStrategy implements ResponseTransformerStrategyInterface, LoggerAwareInterface
{
    ...
    public function handle(
        ...
        throw new BadRequestException($errorDTO, $response->getStatusCode(), $message);
    }
